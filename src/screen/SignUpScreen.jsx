  ...
  return (
    <View style={styles.container}>
      ...
      <View styles={styles.TextContainer}>
            <Text style={styles.headingText}>Aramid kan </Text>
            <Text style={styles.headingText}>Account Mo</Text>
        </View>
        {/*form*/}
        <View style={styles.formContainer}>
            ...
            <View style={styles.inputContainer}>
            <SimpleLineIcons name={"lock"} size={30} color={colors.secondary}/>
                <TextInput style={styles.TextInput} placeholder="Confirm password" placeholderTextColor={colors.secondary} secureTextEntry={secureEntery}/>
                <TouchableOpacity onPress={()=>{setSecureEntery((prev)=>!prev)}}>
                    <SimpleLineIcons name={"eye"} size={20} color={colors.secondary}/>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.footerContainer}>
                ...
                <TouchableOpacity onPress={handleLogin}>
                    <Text styles={styles.SignUpText}>Login</Text>
                </TouchableOpacity>
            </View>
        </View>
    </View>
